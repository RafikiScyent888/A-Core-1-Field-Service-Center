...
import { questionHints, CONTROL_HINTS } from "./hints.js";
...
function hintBox(host) {
  ...
  let wrong = 0;
  return {
    right: () => { wrong = 0; box.hidden = true; box.innerHTML = ""; },
    wrong: (list) => {
      wrong++;
      ...
      box.innerHTML = '<b class="hint__n">Hint ' + (i + 1) + " of " + list.length + "</b>" +
        ...
        (i === list.length - 1
          ? '<span class="hint__t hint__t--last">That is as far as a hint goes. Work it from there \u2014 ' +
            "the answer is on this page, and you have everything you need to find it.</span>"
          : "");
    },
    reset: () => { wrong = 0; box.hidden = true; box.innerHTML = ""; }
  };
}
    ...
    askLocate: function () {
      ...
      claimBtn.addEventListener("click", () => {
        ...
        if (!chosen) {
          fb.style.display = "";
          fb.className = "fb";
          fb.textContent = "Select a part in the list above first, then confirm.";
          return;
        }
...
/* The printer tracks grade a different set: step four is a procedure rather
   ...
   because the measurement question only exists on one of the five tickets
