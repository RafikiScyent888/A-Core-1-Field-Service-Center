...
export const EXERCISES = [
  ...
  { id: "printers", page: "drill", subject: "printers", objs: ["3.7", "3.8"],
    label: "Printers \u2014 types, consumables and maintenance" },
  { id: "ribbon", page: "drill", subject: "ribbon", objs: ["3.7"],
    label: "Thermal transfer \u2014 threading the ribbon" },
  { id: "channels", page: "drill", subject: "channels", objs: ["3.3"],
    label: "Memory channels \u2014 which slots, and what it runs at" },
  { id: "wifisec", page: "drill", subject: "wifisec", objs: ["2.2", "2.6"],
    label: "Wireless security \u2014 what protects the traffic" },
  { id: "mixeddrill", page: "drill", subject: "mixed", objs: ["1.x"],
    label: "Mixed \u2014 the objective is not given, work it out" },
];
