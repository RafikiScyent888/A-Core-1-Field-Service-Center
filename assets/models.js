...
export const HW_BUILD = {
  ...
  cooler: [
    { shape: "rbox", size: [1.5, 0.14, 1.5], pos: [0, -0.76, 0], r: 0.03, shade: 0.72 },
    { shape: "cyl", size: [0.17, 1.45], pos: [-0.42, -0.05, -0.42], shade: 0.8 },
    { shape: "cyl", size: [0.17, 1.45], pos: [0.42, -0.05, -0.42], shade: 0.8 },
    { shape: "cyl", size: [0.17, 1.45], pos: [-0.42, -0.05, 0.42], shade: 0.8 },
    { shape: "cyl", size: [0.17, 1.45], pos: [0.42, -0.05, 0.42], shade: 0.8 },
    { shape: "plate", size: [1.9, 1.15, 0.035], pos: [0, 0.04, -0.88],
      repeat: { count: 26, step: [0, 0, 0.0705] }, shade: 1.12 },
    { shape: "box", size: [2.0, 0.18, 0.13], pos: [0, 0.74, 0.94], r: 0.02, shade: 0.9 },
    { shape: "box", size: [2.0, 0.18, 0.13], pos: [0, 0.74, -0.94], r: 0.02, shade: 0.9 },
    { shape: "box", size: [0.13, 0.18, 1.9], pos: [-0.94, 0.74, 0], r: 0.02, shade: 0.9 },
    { shape: "box", size: [0.13, 0.18, 1.9], pos: [0.94, 0.74, 0], r: 0.02, shade: 0.9 },
    { shape: "cyl", size: [0.56, 0.22], pos: [0, 0.76, 0], shade: 0.65 },
    { shape: "plate", size: [0.74, 0.05, 0.33], pos: [0, 0.76, 0], rot: [0, 0, 0.34],
      ring: { count: 7, radius: 0.46, axis: "y" }, shade: 0.95 },
    { shape: "cyl", size: [0.16, 0.34], pos: [-0.84, 0.66, -0.84], shade: 0.85 },
    { shape: "cyl", size: [0.16, 0.34], pos: [0.84, 0.66, -0.84], shade: 0.85 },
    { shape: "cyl", size: [0.16, 0.34], pos: [-0.84, 0.66, 0.84], shade: 0.85 },
    { shape: "cyl", size: [0.16, 0.34], pos: [0.84, 0.66, 0.84], shade: 0.85 }
  ],
  ...
  dimm: [
    ...
    { shape: "plate", size: [0.13, 0.24, 1.15], pos: [0, -0.62, -0.88], shade: 1.5 },
    { shape: "plate", size: [0.13, 0.24, 1.4], pos: [0, -0.62, 0.76], shade: 1.5 },
    { shape: "box", size: [0.14, 0.46, 0.27], pos: [0, 0.18, -1.16], r: 0.015,
      repeat: { count: 8, step: [0, 0, 0.332] }, shade: 0.42 },
    { shape: "box", size: [0.16, 0.2, 0.18], pos: [0, -0.68, -1.55], r: 0.02, shade: 0.8 },
    { shape: "box", size: [0.16, 0.2, 0.18], pos: [0, -0.68, 1.55], r: 0.02, shade: 0.8 }
  ],

  /* Board, shroud, two shrouded fans, bracket and display ports. */
  gpu: [
    { shape: "plate", size: [4.4, 0.09, 1.5], pos: [0, -0.13, 0], shade: 0.62 },
    { shape: "rbox", size: [4.2, 0.3, 1.45], pos: [0, 0.08, 0], r: 0.05, shade: 1.0 },
    { shape: "cyl", size: [0.42, 0.14], pos: [-1.0, 0.26, 0], shade: 0.6 },
    { shape: "cyl", size: [0.42, 0.14], pos: [1.0, 0.26, 0], shade: 0.6 },
    { shape: "plate", size: [0.6, 0.04, 0.3], pos: [-1.0, 0.26, 0], rot: [0, 0, 0.3],
      ring: { count: 9, radius: 0.4, axis: "y" }, shade: 0.85 },
    { shape: "plate", size: [0.6, 0.04, 0.3], pos: [1.0, 0.26, 0], rot: [0, 0, 0.3],
      ring: { count: 9, radius: 0.4, axis: "y" }, shade: 0.85 },
    { shape: "torus", size: [1.24, 0.06], pos: [-1.0, 0.24, 0], rot: [P2, 0, 0], shade: 0.75 },
    { shape: "torus", size: [1.24, 0.06], pos: [1.0, 0.24, 0], rot: [P2, 0, 0], shade: 0.75 },
    ...
    { shape: "plate", size: [0.09, 0.62, 1.6], pos: [-2.24, 0.18, 0], shade: 1.35 },
    { shape: "box", size: [0.08, 0.22, 0.52], pos: [-2.3, 0.06, -0.4], r: 0.01, shade: 0.35 },
    { shape: "box", size: [0.08, 0.22, 0.52], pos: [-2.3, 0.06, 0.4], r: 0.01, shade: 0.35 },
    { shape: "box", size: [0.42, 0.2, 0.3], pos: [1.85, 0.28, 0.55], r: 0.02, shade: 0.5 },
    { shape: "plate", size: [1.7, 0.1, 0.2], pos: [0.2, -0.2, -0.82], shade: 1.5 }
  ],
  ...
  m2: [
    ...
    { shape: "box", size: [0.34, 0.1, 0.34], pos: [-1.02, 0.08, 0], r: 0.01, shade: 0.55 },
  ...
  psu: [
    ...
    { shape: "cyl", size: [1.95, 0.06], pos: [0, 1.14, 0], shade: 0.55 },
    { shape: "cyl", size: [0.44, 0.14], pos: [0, 1.18, 0], shade: 0.62 },
    ...
    { shape: "box", size: [0.58, 0.52, 0.12], pos: [-0.55, 0.42, -1.45], r: 0.02, shade: 0.35 },
    { shape: "box", size: [0.26, 0.2, 0.1], pos: [0.25, 0.42, -1.45], r: 0.02, shade: 0.85 },
    ...
    { shape: "cyl", size: [0.16, 1.1], pos: [0.45, -0.5, 1.6], rot: [P2, 0, 0.1], shade: 0.45 },
    { shape: "cyl", size: [0.16, 1.1], pos: [0.15, -0.6, 1.6], rot: [P2, 0, -0.05], shade: 0.45 },
    { shape: "cyl", size: [0.16, 1.1], pos: [-0.2, -0.5, 1.6], rot: [P2, 0.08, 0], shade: 0.45 },
    { shape: "plate", size: [1.5, 1.0, 0.02], pos: [0, 0.2, 1.44], shade: 1.3 }
  ],
...
export function mbBuild(W, domed) {
  ...
  add(
    ...
    { shape: "cyl", size: [0.38, 0.42], pos: [CAPX, 0.29, CAPZ],
      repeat: { count: CAPN, step: [CAPSTEP, 0, 0] }, seg: 14, shade: 0.44 },
    { shape: "cyl", size: [0.44, 0.06], pos: [CAPX, 0.11, CAPZ],
      repeat: { count: CAPN, step: [CAPSTEP, 0, 0] }, seg: 14, shade: 0.3 },
    { shape: "plate", size: [0.1, 0.34, 0.06], pos: [CAPX, 0.3, CAPZ - 0.19],
      repeat: { count: CAPN, step: [CAPSTEP, 0, 0] }, shade: 1.35 }
  );
  if (domed) {
    ...
    add(
      ...
      { shape: "sphere", size: [0.46], pos: [CAPX, 0.43, CAPZ],
        repeat: { count: 5, step: [CAPSTEP, 0, 0] }, seg: 14, shade: 1.3 },
      ...
      { shape: "plate", size: [0.34, 0.03, 0.06], pos: [CAPX, 0.63, CAPZ],
        repeat: { count: 5, step: [CAPSTEP, 0, 0] }, shade: 0.4 },
      ...
      { shape: "cyl", size: [0.33, 0.05], pos: [CAPX + CAPSTEP * 5, 0.52, CAPZ],
        repeat: { count: 2, step: [CAPSTEP, 0, 0] }, seg: 14, shade: 1.45 },
      { shape: "plate", size: [0.3, 0.03, 0.045], pos: [CAPX + CAPSTEP * 5, 0.55, CAPZ],
        repeat: { count: 2, step: [CAPSTEP, 0, 0] }, shade: 0.55 },
    ...
    add(
      { shape: "cyl", size: [0.33, 0.05], pos: [CAPX, 0.52, CAPZ],
        repeat: { count: CAPN, step: [CAPSTEP, 0, 0] }, seg: 14, shade: 1.45 },
      { shape: "plate", size: [0.3, 0.03, 0.045], pos: [CAPX, 0.55, CAPZ],
        repeat: { count: CAPN, step: [CAPSTEP, 0, 0] }, shade: 0.55 },
  ...
  add(
    { shape: "cyl", size: [1.12, 0.14], pos: [1.8, 0.15, 3.4], seg: 16, shade: 0.55 },
...
export const LAS_BUILD = {
  tray: [
    ...
    { shape: "plate", size: [0.12, 0.5, 3.1], pos: [1.5, 0.2, 0], shade: 0.85 },
    { shape: "plate", size: [2.7, 0.3, 2.6], pos: [0, 0.2, 0], shade: 1.45 },
    { shape: "box", size: [0.9, 0.16, 0.3], pos: [0, 0.06, 1.75], r: 0.03, shade: 0.8 }
  ],
  roller: [
    { shape: "cyl", size: [0.26, 3.2], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.75 },
    { shape: "cyl", size: [0.95, 0.75], pos: [0, 0, -0.8], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.95, 0.75], pos: [0, 0, 0.8], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.5, 0.2], pos: [0, 0, 1.55], rot: [Math.PI / 2, 0, 0], shade: 0.6 }
  ],
  pad: [
    { shape: "rbox", size: [0.7, 0.22, 2.4], pos: [0, 0, 0], r: 0.04, shade: 1.0 },
    { shape: "plate", size: [0.5, 0.06, 2.1], pos: [0, 0.13, 0], shade: 0.7 },
    { shape: "box", size: [0.22, 0.3, 0.3], pos: [0, -0.18, -1.3], r: 0.02, shade: 0.85 },
    { shape: "box", size: [0.22, 0.3, 0.3], pos: [0, -0.18, 1.3], r: 0.02, shade: 0.85 }
  ],
  drum: [
    { shape: "cyl", size: [2.3, 3.0], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [2.4, 0.18], pos: [0, 0, -1.55], rot: [Math.PI / 2, 0, 0], shade: 0.55 },
    { shape: "cyl", size: [2.4, 0.18], pos: [0, 0, 1.55], rot: [Math.PI / 2, 0, 0], shade: 0.55 },
    { shape: "cyl", size: [1.3, 0.28], pos: [0, 0, 1.75], rot: [Math.PI / 2, 0, 0], shade: 0.7 },
  ...
  smallroller: [
    ...
    { shape: "cyl", size: [0.22, 3.3], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.6 },
    { shape: "cyl", size: [0.5, 0.16], pos: [0, 0, 1.7], rot: [Math.PI / 2, 0, 0], shade: 0.7 }
  ],
  devroller: [
    { shape: "cyl", size: [1.1, 2.9], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.22, 3.3], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.6 },
    { shape: "plate", size: [0.16, 0.4, 2.8], pos: [0.62, 0.42, 0], rot: [0, 0, -0.5], shade: 0.7 }
  ],
  transfer: [
    { shape: "cyl", size: [0.95, 3.0], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.24, 3.4], pos: [0, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.65 },
    { shape: "cyl", size: [0.44, 0.18], pos: [0, 0, 1.78], rot: [Math.PI / 2, 0, 0], shade: 0.75 }
  ],
  fuser: [
    ...
    { shape: "cyl", size: [0.95, 2.9], pos: [-0.25, -0.42, 0], rot: [Math.PI / 2, 0, 0], shade: 0.7 },
    { shape: "cyl", size: [0.5, 0.24], pos: [-0.25, 0.32, 1.65], rot: [Math.PI / 2, 0, 0], shade: 0.62 },
    { shape: "box", size: [0.2, 0.16, 0.3], pos: [0.5, 0.55, -1.0], r: 0.02, shade: 0.55 },
    { shape: "plate", size: [0.06, 0.5, 2.6], pos: [0.9, 0.1, 0], shade: 0.8 }
  ],
  polygon: [
    { shape: "rbox", size: [2.5, 0.75, 2.9], pos: [0, 0, 0], r: 0.05, shade: 1.0 },
    { shape: "cyl", size: [0.75, 0.2], pos: [-0.55, 0.42, 0], shade: 0.6 },
    { shape: "box", size: [0.2, 0.22, 0.22], pos: [-0.55, 0.44, 0],
      ring: { count: 6, radius: 0.34, axis: "y" }, shade: 1.4 },
    { shape: "plate", size: [1.5, 0.08, 0.3], pos: [0.5, 0.4, 0], rot: [0, 0, -0.25], shade: 1.3 },
    { shape: "plate", size: [1.9, 0.05, 0.34], pos: [0.2, -0.38, 0], shade: 1.45 }
  ],
  waste: [
    { shape: "rbox", size: [1.35, 0.85, 2.9], pos: [0, 0, 0], r: 0.05, shade: 1.0 },
    { shape: "plate", size: [0.1, 0.4, 2.7], pos: [-0.6, 0.3, 0], rot: [0, 0, 0.3], shade: 0.62 },
    { shape: "box", size: [0.3, 0.2, 0.4], pos: [0.5, 0.5, 1.2], r: 0.02, shade: 0.75 }
  ],
  gears: [
    { shape: "plate", size: [3.9, 2.9, 0.12], pos: [0, 0, 0], shade: 0.75 },
    { shape: "cyl", size: [1.3, 0.22], pos: [-1.0, 0.5, 0.2], rot: [Math.PI / 2, 0, 0], shade: 1.0 },
    { shape: "box", size: [0.16, 0.3, 0.22], pos: [-1.0, 0.5, 0.2], rot: [Math.PI / 2, 0, 0],
      ring: { count: 14, radius: 0.62, axis: "z" }, shade: 1.0 },
    { shape: "cyl", size: [0.9, 0.22], pos: [0.3, -0.3, 0.2], rot: [Math.PI / 2, 0, 0], shade: 0.9 },
    { shape: "box", size: [0.14, 0.26, 0.22], pos: [0.3, -0.3, 0.2], rot: [Math.PI / 2, 0, 0],
      ring: { count: 11, radius: 0.44, axis: "z" }, shade: 0.9 },
    { shape: "cyl", size: [0.65, 0.22], pos: [1.35, 0.55, 0.2], rot: [Math.PI / 2, 0, 0], shade: 0.85 },
    { shape: "cyl", size: [1.0, 0.5], pos: [-1.9, -0.7, 0.2], rot: [Math.PI / 2, 0, 0], shade: 0.6 }
  ],
  ozone: [
...
export const INK_BUILD = {
  ...
  carriage: [
    ...
    { shape: "box", size: [1.2, 0.2, 0.9], pos: [0, 0.58, 0], r: 0.03, shade: 0.8 },
    { shape: "plate", size: [0.5, 0.05, 1.0], pos: [0, 0.72, 0], shade: 1.3 },
    { shape: "box", size: [0.28, 0.5, 0.3], pos: [-0.72, 0.1, -0.5], r: 0.02, shade: 0.65 },
    { shape: "cyl", size: [0.3, 1.9], pos: [0, -0.1, 0], rot: [0, 0, Math.PI / 2], shade: 0.6 }
  ],
  printhead: [
    ...
    { shape: "plate", size: [0.3, 0.1, 0.9], pos: [0.62, 0.1, 0], shade: 0.7 }
  ],
  belt: [
    { shape: "plate", size: [8.4, 0.16, 0.14], pos: [0, 0.14, 0], shade: 1.0 },
    { shape: "plate", size: [8.4, 0.16, 0.14], pos: [0, -0.14, 0], shade: 1.0 },
    { shape: "plate", size: [0.06, 0.1, 0.16], pos: [-4.1, 0.22, 0],
      repeat: { count: 42, step: [0.2, 0, 0] }, shade: 0.75 },
    { shape: "cyl", size: [0.5, 0.3], pos: [-4.35, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.7 },
    { shape: "cyl", size: [0.5, 0.3], pos: [4.35, 0, 0], rot: [Math.PI / 2, 0, 0], shade: 0.7 },
    { shape: "rbox", size: [0.85, 0.85, 0.85], pos: [4.85, 0, 0], r: 0.05, shade: 0.55 }
  ],
  encoder: [
    { shape: "plate", size: [9.0, 0.5, 0.05], pos: [0, 0, 0], shade: 1.0 },
    { shape: "plate", size: [0.05, 0.34, 0.07], pos: [-4.4, 0, 0.02],
      repeat: { count: 60, step: [0.149, 0, 0] }, shade: 0.42 },
    { shape: "box", size: [0.2, 0.7, 0.16], pos: [-4.6, 0, 0], r: 0.02, shade: 0.7 },
    { shape: "box", size: [0.2, 0.7, 0.16], pos: [4.6, 0, 0], r: 0.02, shade: 0.7 }
  ],
  capping: [
    { shape: "rbox", size: [1.05, 0.5, 1.25], pos: [0, 0, 0], r: 0.05, shade: 1.0 },
    { shape: "box", size: [0.82, 0.12, 1.0], pos: [0, 0.28, 0], r: 0.04, shade: 0.62 },
    { shape: "plate", size: [0.6, 0.06, 0.78], pos: [0, 0.3, 0], shade: 0.45 },
    { shape: "cyl", size: [0.22, 0.9], pos: [0, -0.3, 0.75], rot: [Math.PI / 2, 0, 0], shade: 0.7 }
  ],
  wiper: [
    { shape: "rbox", size: [0.34, 0.28, 1.05], pos: [0, -0.1, 0], r: 0.03, shade: 1.0 },
    { shape: "plate", size: [0.08, 0.34, 0.95], pos: [0, 0.2, 0], shade: 0.6 }
  ],
  pump: [
    { shape: "cyl", size: [0.82, 0.7], pos: [0, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.3, 0.3], pos: [0, 0.44, 0], shade: 0.65 },
    { shape: "cyl", size: [0.2, 0.9], pos: [0, 0, 0.6], rot: [Math.PI / 2, 0, 0], shade: 0.7 },
    { shape: "cyl", size: [0.2, 0.9], pos: [0, 0, -0.6], rot: [Math.PI / 2, 0, 0], shade: 0.7 }
  ],
  wastepad: [
    ...
    { shape: "plate", size: [0.16, 0.34, 1.9], pos: [-1.6, 0.05, 0], shade: 0.68 },
    { shape: "plate", size: [0.16, 0.34, 1.9], pos: [1.6, 0.05, 0], shade: 0.68 }
  ],
  starwheel: [
    { shape: "cyl", size: [0.2, 2.4], pos: [0, 0, 0], rot: [0, 0, Math.PI / 2], shade: 0.65 },
    { shape: "cyl", size: [0.6, 0.06], pos: [-0.8, 0, 0], rot: [0, 0, Math.PI / 2], shade: 1.0 },
    { shape: "cyl", size: [0.6, 0.06], pos: [0, 0, 0], rot: [0, 0, Math.PI / 2], shade: 1.0 },
    { shape: "cyl", size: [0.6, 0.06], pos: [0.8, 0, 0], rot: [0, 0, Math.PI / 2], shade: 1.0 },
  ...
  encoderwheel: [
    { shape: "cyl", size: [1.0, 0.1], pos: [0, 0, 0], rot: [0, 0, Math.PI / 2], shade: 1.0 },
    { shape: "cyl", size: [0.28, 0.34], pos: [0, 0, 0], rot: [0, 0, Math.PI / 2], shade: 0.6 },
...
export const MOB_BUILD = {
  ...
  earpiece: [
    ...
    { shape: "cyl", size: [0.3, 0.24], pos: [0, -0.16, 0], shade: 0.6 },
    { shape: "cyl", size: [0.16, 0.1], pos: [0, -0.3, 0], shade: 1.35 }
  ],
  glass: [
    { shape: "rbox", size: [3.1, 0.1, 6.3], pos: [0, 0, 0], r: 0.14, shade: 1.0 },
    { shape: "cyl", size: [0.34, 0.12], pos: [-0.95, 0, 2.75], shade: 0.5 },
    { shape: "box", size: [0.7, 0.06, 0.11], pos: [0.15, 0.02, 2.8], r: 0.03, shade: 0.55 }
  ],
  digitizer: [
    ...
    { shape: "plate", size: [0.7, 0.04, 0.9], pos: [0, -0.04, -3.4], shade: 0.62 }
  ],
  screen: [
    { shape: "rbox", size: [2.95, 0.13, 6.05], pos: [0, 0, 0], r: 0.1, shade: 1.0 },
    { shape: "plate", size: [2.75, 0.03, 5.8], pos: [0, 0.08, 0], shade: 1.35 },
    { shape: "plate", size: [0.85, 0.05, 1.0], pos: [0, -0.07, -3.3], shade: 0.6 }
  ],
  battery: [
    { shape: "rbox", size: [2.35, 0.4, 3.15], pos: [0, 0, 0], r: 0.06, shade: 1.0 },
    { shape: "plate", size: [1.6, 0.02, 2.2], pos: [0, 0.21, 0], shade: 1.25 },
    { shape: "plate", size: [0.5, 0.05, 0.55], pos: [0.75, 0.05, -1.85], shade: 0.72 },
    { shape: "box", size: [0.45, 0.14, 0.22], pos: [0.75, 0.05, -2.05], r: 0.02, shade: 0.5 },
    { shape: "plate", size: [1.9, 0.03, 0.28], pos: [0, 0.2, 1.4], shade: 0.7 }
  ],
  logic: [
    { shape: "plate", size: [1.65, 0.14, 1.55], pos: [0, 0, 0], shade: 1.0 },
    { shape: "box", size: [0.65, 0.1, 0.6], pos: [-0.3, 0.11, 0.2], r: 0.02, shade: 1.35 },
    { shape: "box", size: [0.45, 0.09, 0.42], pos: [0.42, 0.11, -0.3], r: 0.02, shade: 1.35 },
    { shape: "box", size: [0.18, 0.09, 0.5], pos: [-0.66, 0.1, -0.42], r: 0.02, shade: 0.55 },
    { shape: "box", size: [0.3, 0.07, 0.16], pos: [0.5, 0.1, 0.55], r: 0.02, shade: 0.6 }
  ],
  port: [
    { shape: "rbox", size: [0.86, 0.28, 0.46], pos: [0, 0, 0], r: 0.09, shade: 1.0 },
    { shape: "box", size: [0.6, 0.13, 0.2], pos: [0, 0, -0.16], r: 0.05, shade: 0.42 },
    { shape: "plate", size: [0.42, 0.03, 0.05], pos: [0, 0.03, -0.16], shade: 1.4 },
    { shape: "plate", size: [1.15, 0.05, 0.3], pos: [0, -0.1, 0.24], shade: 0.62 }
  ],
  camera: [
    { shape: "rbox", size: [0.78, 0.26, 0.78], pos: [0, 0, 0], r: 0.1, shade: 1.0 },
    { shape: "cyl", size: [0.5, 0.22], pos: [0, 0.1, 0], shade: 0.55 },
    { shape: "cyl", size: [0.34, 0.14], pos: [0, 0.2, 0], shade: 0.3 },
    { shape: "cyl", size: [0.18, 0.1], pos: [0.3, 0.16, 0.3], shade: 1.45 }
  ],
  sim: [
    { shape: "rbox", size: [0.32, 0.14, 0.95], pos: [0, 0, 0], r: 0.04, shade: 1.0 },
    { shape: "box", size: [0.26, 0.06, 0.5], pos: [0, 0.06, 0.05], r: 0.02, shade: 1.4 },
    { shape: "cyl", size: [0.1, 0.16], pos: [0, 0, -0.5], rot: [Math.PI / 2, 0, 0], shade: 0.6 },
    { shape: "plate", size: [0.22, 0.03, 0.8], pos: [0.2, -0.04, 0.2], shade: 0.66 }
  ],
  body: [
    { shape: "rbox", size: [3.35, 0.45, 6.55], pos: [0, 0, 0], r: 0.2, shade: 1.0 },
    { shape: "plate", size: [3.0, 0.16, 6.2], pos: [0, 0.16, 0], shade: 0.82 },
    { shape: "box", size: [0.1, 0.16, 0.75], pos: [1.7, 0.06, 1.0], r: 0.04, shade: 0.7 },
    { shape: "box", size: [0.1, 0.16, 0.42], pos: [1.7, 0.06, 1.95], r: 0.04, shade: 0.7 },
    { shape: "box", size: [0.1, 0.16, 0.42], pos: [-1.7, 0.06, 1.7], r: 0.04, shade: 0.7 },
...
export const NET_BUILD = {
  pc: [
    ...
    { shape: "plate", size: [0.1, 2.1, 1.5], pos: [0.85, 0, 0], shade: 0.86 },
    { shape: "box", size: [0.12, 0.35, 0.5], pos: [0.88, 0.6, 0.3], r: 0.02, shade: 0.5 },
    { shape: "cyl", size: [0.2, 0.1], pos: [0.9, 0.9, -0.4], rot: [0, 0, Math.PI / 2], shade: 1.4 },
  ...
  cable: [
    ...
    { shape: "rbox", size: [0.36, 0.28, 0.28], pos: [-1.85, 0, 0], r: 0.05, shade: 0.7 },
    { shape: "rbox", size: [0.36, 0.28, 0.28], pos: [1.85, 0, 0], r: 0.05, shade: 0.7 },
    { shape: "box", size: [0.3, 0.24, 0.22], pos: [-2.14, 0, 0], r: 0.03, shade: 1.3 },
    { shape: "box", size: [0.3, 0.24, 0.22], pos: [2.14, 0, 0], r: 0.03, shade: 1.3 }
  ],
  shortcable: [
...
export function hardwareModel(G) {
  ...
  var parts = [
    {
      ...
      build: HW_BUILD.cooler, finish: "metal", scale: W,
    ...
    },
    {
      ...
      build: HW_BUILD.dimm, finish: "board", scale: W,
    ...
    },
    {
      ...
      build: HW_BUILD.gpu, finish: "plastic", scale: W,
  ...
  parts.push({
    ...
    build: mbBuild(1, f === "bulgecap"), finish: "board", scale: W,
...
export function laptopModel(G, parts) {
  const s = G.seedBase, target = G.partTarget;
  const geo = {
    cover:      { build: LAP_BUILD.cover,      finish: "metal",   pos: [0.4, -2.4, 0] },
    ssd:        { build: LAP_BUILD.ssd,        finish: "board",   pos: [-3.4, 0, -2.4] },
    sodimm1:    { build: LAP_BUILD.sodimm,     finish: "board",   pos: [-3.4, 0, -0.6] },
    sodimm2:    { build: LAP_BUILD.sodimm,     finish: "board",   pos: [-3.4, 0, 0.6] },
    wifi:       { build: LAP_BUILD.wifi,       finish: "board",   pos: [-3.0, 0, 2.3] },
    board:      { build: LAP_BUILD.board,      finish: "board",   pos: [0.6, 0, -1.4] },
    battery:    { build: LAP_BUILD.battery,    finish: "matte",   pos: [0.4, 0, 1.8] },
    fan:        { build: LAP_BUILD.fan,        finish: "plastic", pos: [4.6, 0, -1.4] },
    ports:      { build: LAP_BUILD.ports,      finish: "board",   pos: [4.6, 0, 1.8] },
    ...
    displayasm: { build: LAP_BUILD.displayasm, finish: "metal",   pos: [0.4, 4.5, -0.2] }
  };
  return {
    kind: "laptop",
...
const DISP_BUILD = {
  panel: [
    ...
    { shape: "plate", size: [5.0, 0.03, 0.14], pos: [0, -0.09, -1.7], shade: 0.6 }
  ],
  backlight: [
    { shape: "rbox", size: [5.8, 0.22, 3.6], pos: [0, 0, 0], r: 0.05, shade: 1.0 },
    { shape: "plate", size: [5.4, 0.05, 3.2], pos: [0, 0.13, 0], shade: 1.45 },
    { shape: "box", size: [0.18, 0.1, 0.1], pos: [-2.5, 0.16, -1.72],
      repeat: { count: 15, step: [0.36, 0, 0] }, shade: 1.5 },
    { shape: "plate", size: [0.3, 0.06, 3.0], pos: [-2.85, 0.05, 0], shade: 0.72 }
  ],
  driver: [
    { shape: "plate", size: [2.2, 0.12, 0.75], pos: [0, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [0.3, 0.38], pos: [-0.6, 0.2, 0], shade: 0.5 },
    { shape: "cyl", size: [0.3, 0.38], pos: [-0.15, 0.2, 0], shade: 0.5 },
    { shape: "box", size: [0.5, 0.24, 0.4], pos: [0.55, 0.15, 0], r: 0.03, shade: 0.66 },
    { shape: "plate", size: [0.4, 0.1, 0.2], pos: [1.05, 0, -0.2], shade: 1.4 }
  ],
  vidcable: [
    { shape: "plate", size: [0.55, 0.06, 3.2], pos: [0, 0, 0], shade: 1.0 },
    { shape: "rbox", size: [0.7, 0.16, 0.3], pos: [0, 0.04, -1.7], r: 0.03, shade: 0.55 },
    { shape: "rbox", size: [0.7, 0.16, 0.3], pos: [0, 0.04, 1.7], r: 0.03, shade: 0.55 },
    { shape: "plate", size: [0.6, 0.05, 0.35], pos: [0, 0.06, 0.1], shade: 0.68 }
  ],
  gpu: [
    { shape: "plate", size: [1.7, 0.12, 1.4], pos: [0, 0, 0], shade: 1.0 },
    { shape: "box", size: [0.8, 0.18, 0.8], pos: [0, 0.14, 0], r: 0.02, shade: 0.66 },
    { shape: "cyl", size: [0.16, 0.24], pos: [-0.65, 0.14, -0.5],
      repeat: { count: 4, step: [0.42, 0, 0] }, shade: 0.5 }
  ],
  vidport: [
    { shape: "rbox", size: [1.1, 0.44, 0.6], pos: [0, 0, 0], r: 0.04, shade: 1.0 },
    { shape: "box", size: [0.62, 0.24, 0.3], pos: [0.24, 0, 0], r: 0.03, shade: 0.42 },
    { shape: "cyl", size: [0.14, 0.7], pos: [-0.75, 0, 0], rot: [0, 0, Math.PI / 2], shade: 0.55 }
  ],
  lamp: [
    { shape: "cyl", size: [1.2, 0.5], pos: [0, 0, 0], shade: 1.0 },
    { shape: "sphere", size: [0.62, 0.62, 0.62], pos: [0, 0.42, 0], shade: 1.5 },
    { shape: "cone", size: [1.5, 0.7, 0.6], pos: [0, -0.4, 0], shade: 1.25 },
    { shape: "box", size: [0.3, 0.2, 0.24], pos: [0.7, -0.2, 0], r: 0.02, shade: 0.5 }
  ],
  filter: [
    { shape: "rbox", size: [2.0, 0.24, 1.5], pos: [0, 0, 0], r: 0.04, shade: 1.0 },
    { shape: "plate", size: [1.7, 0.1, 0.08], pos: [0, 0.12, -0.6],
      repeat: { count: 13, step: [0, 0, 0.1] }, shade: 0.72 },
...
const CAB_BUILD = {
  ...
  plug: [
    ...
    { shape: "box", size: [0.06, 0.3, 0.12], pos: [-0.31, 0.24, -0.62],
      repeat: { count: 8, step: [0.089, 0, 0] }, shade: 1.55 },
  ...
  keystone: [
    ...
    { shape: "box", size: [0.78, 0.34, 0.9], pos: [0, 0.36, -0.7], r: 0.02, shade: 0.3 },
    { shape: "box", size: [0.16, 0.26, 0.5], pos: [-0.7, 0.2, 1.0],
      repeat: { count: 4, step: [0.46, 0, 0] }, shade: 1.4 },
    { shape: "box", size: [0.16, 0.26, 0.5], pos: [-0.7, 0.2, 1.55],
      repeat: { count: 4, step: [0.46, 0, 0] }, shade: 1.4 },
    { shape: "cyl", size: [0.14, 0.16], pos: [0, 0.1, -1.5], shade: 0.6 },
    { shape: "cyl", size: [0.14, 0.16], pos: [0, 0.1, 1.5], shade: 0.6 }
  ],
  ...
  horizontal: [
    ...
    { shape: "box", size: [0.5, 0.9, 0.5], pos: [-1.6, 0.5, 0], r: 0.04,
      repeat: { count: 3, step: [1.6, 0, 0] }, shade: 0.55 },
    { shape: "plate", size: [8.0, 0.1, 0.6], pos: [0, 0.95, 0], shade: 0.86 }
  ],
  ...
  panel: [
    ...
    { shape: "box", size: [0.44, 0.5, 0.34], pos: [-3.0, 0.3, 0.2],
      repeat: { count: 12, step: [0.55, 0, 0] }, shade: 0.4 },
    { shape: "box", size: [0.44, 0.5, 0.34], pos: [-3.0, -0.35, 0.2],
      repeat: { count: 12, step: [0.55, 0, 0] }, shade: 0.4 },
    { shape: "cyl", size: [0.14, 0.3], pos: [-3.5, 0.62, 0.16], rot: [Math.PI / 2, 0, 0], shade: 1.4 },
    { shape: "cyl", size: [0.14, 0.3], pos: [3.5, 0.62, 0.16], rot: [Math.PI / 2, 0, 0], shade: 1.4 }
  ],
  ...
  cord: [
    ...
    { shape: "rbox", size: [0.8, 0.66, 0.6], pos: [2.3, 0, 0], r: 0.14, shade: 0.6 },
    { shape: "rbox", size: [0.6, 0.56, 1.0], pos: [-2.95, 0, 0], r: 0.05, shade: 0.82 },
    { shape: "rbox", size: [0.6, 0.56, 1.0], pos: [2.95, 0, 0], r: 0.05, shade: 0.82 },
    { shape: "plate", size: [1.4, 0.06, 0.3], pos: [0, 0.2, 0], shade: 1.45 }
  ],
  ...
  switchbox: [
    ...
    { shape: "box", size: [0.42, 0.44, 0.3], pos: [-2.8, 0.25, 1.2],
      repeat: { count: 11, step: [0.52, 0, 0] }, shade: 0.35 },
    ...
    { shape: "plate", size: [0.08, 0.9, 2.2], pos: [3.3, 0, 0],
      repeat: { count: 5, step: [0.1, 0, 0] }, shade: 0.7 }
  ]
};
...
const PWR_BUILD = {
  ...
  breaker: [
    ...
    { shape: "plate", size: [2.6, 4.2, 0.1], pos: [0, 0, 0.5], shade: 0.72 },
    { shape: "rbox", size: [0.9, 0.34, 0.3], pos: [-0.62, 1.7, 0.62], r: 0.04,
      repeat: { count: 5, step: [0, -0.55, 0] }, shade: 0.45 },
    { shape: "rbox", size: [0.9, 0.34, 0.3], pos: [0.62, 1.7, 0.62], r: 0.04,
      repeat: { count: 5, step: [0, -0.55, 0] }, shade: 0.45 },
  ...
  outlet: [
    ...
    { shape: "rbox", size: [1.5, 1.3, 0.14], pos: [0, -0.72, 0.1], r: 0.28, shade: 0.86 },
    { shape: "box", size: [0.13, 0.42, 0.1], pos: [-0.34, 0.92, 0.18], shade: 0.24 },
    { shape: "box", size: [0.13, 0.42, 0.1], pos: [0.34, 0.92, 0.18], shade: 0.24 },
    { shape: "cyl", size: [0.16, 0.1], pos: [0, 0.36, 0.18], rot: [Math.PI / 2, 0, 0], shade: 0.24 },
    { shape: "box", size: [0.13, 0.42, 0.1], pos: [-0.34, -0.52, 0.18], shade: 0.24 },
    { shape: "box", size: [0.13, 0.42, 0.1], pos: [0.34, -0.52, 0.18], shade: 0.24 },
    { shape: "cyl", size: [0.16, 0.1], pos: [0, -1.08, 0.18], rot: [Math.PI / 2, 0, 0], shade: 0.24 },
    { shape: "cyl", size: [0.13, 0.16], pos: [0, 1.48, 0.1], shade: 0.6 },
    { shape: "cyl", size: [0.13, 0.16], pos: [0, -1.48, 0.1], shade: 0.6 }
  ],
  ...
  strip: [
    ...
    { shape: "box", size: [0.12, 0.2, 0.28], pos: [-2.36, 0.42, -0.16],
      repeat: { count: 6, step: [0.88, 0, 0] }, shade: 0.24 },
  ...
  ups: [
    ...
    { shape: "plate", size: [1.9, 1.5, 0.1], pos: [0, 1.2, 1.75], shade: 0.4 },
    ...
    { shape: "box", size: [0.1, 0.28, 0.1], pos: [-1.0, -1.4, 1.74],
      repeat: { count: 11, step: [0.2, 0, 0] }, shade: 0.62 },
    { shape: "rbox", size: [2.2, 0.2, 0.6], pos: [0, -2.1, 0.4], r: 0.04, shade: 0.7 }
  ],
  ...
  upscell: [
    ...
    { shape: "rbox", size: [1.5, 1.7, 2.6], pos: [0.8, 0, 0], r: 0.05, shade: 1.0 },
    { shape: "cyl", size: [0.16, 0.24], pos: [-1.15, 0.95, -0.85], shade: 0.55 },
    { shape: "cyl", size: [0.16, 0.24], pos: [-0.45, 0.95, -0.85], shade: 0.55 },
    { shape: "cyl", size: [0.16, 0.24], pos: [0.45, 0.95, -0.85], shade: 0.55 },
    { shape: "cyl", size: [0.16, 0.24], pos: [1.15, 0.95, -0.85], shade: 0.55 },
    { shape: "plate", size: [3.0, 0.1, 0.5], pos: [0, 0.95, 0.7], shade: 0.42 },
    { shape: "rbox", size: [0.7, 0.4, 0.5], pos: [0, 0.95, 1.5], r: 0.05, shade: 0.3 },
    { shape: "plate", size: [1.1, 0.06, 0.7], pos: [-0.8, 0.88, -0.2], shade: 1.4 }
  ],
  /* An ATX supply: case, fan grille, the switch and inlet, and the loom. */
  psu: [
    { shape: "rbox", size: [3.4, 1.7, 3.0], pos: [0, 0, 0], r: 0.06, shade: 1.0 },
    { shape: "cyl", size: [1.15, 0.12], pos: [0, 0.88, 0.2], shade: 0.62 },
    { shape: "plate", size: [0.4, 0.06, 2.0], pos: [-0.85, 0.95, 0.2], rot: [0, 0.4, 0],
      ring: { count: 9, radius: 0.85, axis: "y" }, shade: 0.5 },
    { shape: "rbox", size: [0.9, 0.75, 0.2], pos: [-0.9, 0, -1.55], r: 0.04, shade: 0.4 },
    { shape: "rbox", size: [0.5, 0.35, 0.2], pos: [0.4, 0, -1.55], r: 0.03, shade: 0.42 },
    { shape: "box", size: [0.9, 0.5, 0.1], pos: [1.3, 0, -1.55], shade: 1.35 },
  ...
  atx24: [
    ...
    { shape: "box", size: [0.14, 0.5, 0.14], pos: [-0.99, 0.2, -0.3],
      repeat: { count: 12, step: [0.18, 0, 0] }, shade: 0.4 },
  ...
  module: [
    ...
    { shape: "box", size: [0.5, 0.2, 0.5], pos: [-0.4, 0.16, 0.1], r: 0.02, shade: 0.5 },
    { shape: "box", size: [0.34, 0.14, 0.34], pos: [0.5, 0.13, 0.1], r: 0.02, shade: 0.62 },
    { shape: "plate", size: [1.3, 0.1, 0.12], pos: [-0.2, 0, -0.62], shade: 1.5 },
    { shape: "plate", size: [0.1, 1.5, 1.2], pos: [1.28, 0.6, 0], shade: 1.25 },
    { shape: "cyl", size: [0.12, 0.2], pos: [-0.9, 0.14, -0.35],
      repeat: { count: 3, step: [0.3, 0, 0] }, shade: 0.7 }
  ]
};
...
/* =====================================================================
   ...
   ===================================================================== */
const RAID_BUILD = {
  /* A hot-swap carrier: the tray, the disk inside it, the latch and the
     two indicator lights on the front face. */
  carrier: [
    { shape: "rbox", size: [1.5, 1.05, 4.6], pos: [0, 0, 0], r: 0.06, shade: 1.0 },
    { shape: "rbox", size: [1.2, 0.7, 3.9], pos: [0, 0.05, 0.2], r: 0.04, shade: 0.72 },
    { shape: "plate", size: [0.9, 0.06, 2.6], pos: [0, 0.42, 0.3], shade: 1.3 },
    { shape: "rbox", size: [0.34, 0.8, 0.22], pos: [-0.5, 0, -2.35], r: 0.03, shade: 0.5 },
    { shape: "cyl", size: [0.12, 0.14], pos: [0.28, 0.22, -2.36], rot: [Math.PI / 2, 0, 0], shade: 1.6 },
    { shape: "cyl", size: [0.12, 0.14], pos: [0.28, -0.16, -2.36], rot: [Math.PI / 2, 0, 0], shade: 1.45 },
    { shape: "box", size: [0.14, 0.5, 0.1], pos: [0.62, 0, -2.36], shade: 0.4 }
  ],
  /* The chassis the carriers slide into. */
  enclosure: [
    { shape: "rbox", size: [14.0, 2.2, 5.4], pos: [0, 0, 0], r: 0.1, shade: 1.0 },
    { shape: "plate", size: [13.2, 0.08, 4.6], pos: [0, -1.05, 0.2], shade: 0.66 },
    { shape: "box", size: [0.3, 1.6, 0.4], pos: [-6.7, 0, -2.5], r: 0.04, shade: 0.55 },
    { shape: "box", size: [0.3, 1.6, 0.4], pos: [6.7, 0, -2.5], r: 0.04, shade: 0.55 },
    { shape: "cyl", size: [0.14, 0.2], pos: [-6.2, 0.6, -2.6], rot: [Math.PI / 2, 0, 0], shade: 1.5 },
    { shape: "plate", size: [0.1, 1.4, 4.2], pos: [0, 0, 0], repeat: { count: 9, step: [1.55, 0, 0] },
      shade: 0.78 }
  ],
  ...
  controller: [
    ...
    { shape: "box", size: [1.1, 0.5, 1.1], pos: [-0.6, 0.3, 0], r: 0.03, shade: 0.5 },
    { shape: "plate", size: [0.06, 0.55, 0.9], pos: [-1.1, 0.35, 0],
      repeat: { count: 12, step: [0.09, 0, 0] }, shade: 0.62 },
    { shape: "rbox", size: [0.7, 0.34, 0.5], pos: [1.5, 0.2, -0.5], r: 0.03,
      repeat: { count: 2, step: [0, 0, 1.0] }, shade: 0.4 },
    { shape: "plate", size: [0.1, 1.7, 1.8], pos: [-2.4, 0.8, 0], shade: 1.25 },
    { shape: "cyl", size: [0.16, 0.3], pos: [1.0, 0.2, 0.7], shade: 0.68 },
    { shape: "plate", size: [1.6, 0.09, 0.14], pos: [0.4, 0, -0.9], shade: 1.45 }
  ],
  ...
  cache: [
    ...
    { shape: "box", size: [0.42, 0.24, 0.44], pos: [-0.55, 0.16, 0], r: 0.02,
      repeat: { count: 3, step: [0.55, 0, 0] }, shade: 0.5 },
    ...
    { shape: "plate", size: [0.8, 0.05, 0.3], pos: [0, 0.32, 1.3], shade: 1.4 }
  ],
  /* Tape and a network target — the thing that is not the array. */
  backup: [
    { shape: "rbox", size: [3.4, 1.6, 2.6], pos: [0, 0, 0], r: 0.08, shade: 1.0 },
    { shape: "rbox", size: [1.9, 0.24, 1.5], pos: [0, 0.7, 0.3], r: 0.05, shade: 0.7 },
    { shape: "cyl", size: [0.5, 0.2], pos: [-0.45, 0.85, 0.3], shade: 0.45 },
    { shape: "cyl", size: [0.5, 0.2], pos: [0.5, 0.85, 0.3], shade: 0.45 },
...
const PNET_BUILD = {
  workstation: [
    ...
    { shape: "plate", size: [0.08, 3.2, 3.6], pos: [0.98, 0, 0], shade: 0.72 },
    { shape: "cyl", size: [0.5, 0.14], pos: [0.99, 1.2, -1.2], rot: [0, 0, Math.PI / 2], shade: 0.5 },
    { shape: "box", size: [0.16, 0.7, 0.12], pos: [0.99, -0.4, -1.2],
      repeat: { count: 4, step: [0, 0, 0.55] }, shade: 0.4 },
    { shape: "cyl", size: [0.11, 0.14], pos: [0.99, 1.9, 1.4], rot: [0, 0, Math.PI / 2], shade: 1.6 },
    { shape: "plate", size: [0.06, 0.5, 3.0], pos: [-0.98, 0, 0],
      repeat: { count: 6, step: [-0.07, 0, 0] }, shade: 0.66 }
  ],
  usbcable: [
  ...
  switch: [
    ...
    { shape: "plate", size: [0.07, 0.85, 2.0], pos: [3.05, 0, 0],
      repeat: { count: 5, step: [0.09, 0, 0] }, shade: 0.72 }
  ],
  ...
  printer: [
    ...
    { shape: "rbox", size: [2.4, 0.3, 1.5], pos: [-1.2, 2.75, 1.5], r: 0.06, shade: 0.45 },
    ...
    { shape: "box", size: [3.4, 0.16, 0.5], pos: [0, 1.4, 2.3], shade: 0.35 },
    { shape: "box", size: [0.16, 0.5, 0.12], pos: [2.5, -2.0, -2.32], shade: 0.4 }
  ],
  server: [
    { shape: "rbox", size: [6.0, 1.6, 4.4], pos: [0, 0, 0], r: 0.06, shade: 1.0 },
    { shape: "plate", size: [0.1, 1.0, 0.8], pos: [-2.4, 0, 2.24],
      repeat: { count: 6, step: [0.9, 0, 0] }, shade: 0.62 },
    ...
    { shape: "box", size: [5.4, 0.1, 0.3], pos: [0, 0.85, 0], shade: 0.78 }
  ],
  ap: [
    { shape: "cyl", size: [2.0, 0.5], pos: [0, 0, 0], shade: 1.0 },
    { shape: "cyl", size: [1.5, 0.2], pos: [0, 0.32, 0], shade: 0.82 },
    { shape: "cyl", size: [0.2, 0.16], pos: [0, 0.45, 0.9], shade: 1.55 },
    { shape: "box", size: [0.5, 0.3, 0.4], pos: [1.6, -0.2, 0], r: 0.03, shade: 0.5 },
    { shape: "cyl", size: [0.1, 1.2], pos: [0, -0.5, 0], shade: 0.66 }
  ]
};
...
export function displayModel(G, parts) {
  ...
  const geo = {
    ...
    panel:     { build: DISP_BUILD.panel,     finish: "glass",   pos: [-1.6, 1.5, 0] },
    driver:    { build: DISP_BUILD.driver,    finish: "board",   pos: [-1.4, -1.5, 2.6] },
    vidcable:  { build: DISP_BUILD.vidcable,  finish: "rubber",  pos: [2.6, -0.5, 0] },
    gpu:       { build: DISP_BUILD.gpu,       finish: "board",   pos: [2.6, -1.6, -2.8] },
